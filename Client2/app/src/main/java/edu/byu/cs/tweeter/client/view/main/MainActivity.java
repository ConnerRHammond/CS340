...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainActivityPresenter.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new MainActivityPresenter(this,selectedUser,Cache.getInstance().getCurrUserAuthToken(),true);
    ...
    @Override
    public void setVisibulity(Boolean value) {
        if (value) {

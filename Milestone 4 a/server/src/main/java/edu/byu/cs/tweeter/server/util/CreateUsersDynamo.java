...
//            String post = "This is my first postg "+
...
//            storyDAO.postStatus(status,user.getAlias());
//            feedDAO.createStatuses(user);
//            feedDAO.postStatus(status,"@allen");
...
//            storyDAO.createStatuses(user);
                ...
                String datetime = calendar.getTime().toString();
                Status status = new Status(post, user, datetime, urls, mentions);
                storyDAO.postStatus(status,"@allen" );
                //feedDAO.postStatus(status,user.getAlias());
        }
    }

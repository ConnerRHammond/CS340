...
//
//        UsersResponse response1 = new UsersResponse(Collections.emptyList(), false);
...
//            throws InterruptedException, IOException, TweeterRemoteException {
//
//        UsersResponse response1 = new UsersResponse(Collections.singletonList(user2), false);
//        Mockito.doReturn(response1).when(serverFacadeMock).getFollowees(Mockito.any(), Mockito.any());
//
//        followingPresenterSpy.loadMoreItems();
//        awaitCountDownLatch();
...
//            throws InterruptedException, IOException, TweeterRemoteException {
//
//        UsersResponse response1 = new UsersResponse(Arrays.asList(user2, user3), false);
//        Mockito.doReturn(response1).when(serverFacadeMock).getFollowees(Mockito.any(), Mockito.any());
//
//        followingPresenterSpy.loadMoreItems();
//        awaitCountDownLatch();
...
//            throws InterruptedException, IOException, TweeterRemoteException {
//
//        UsersResponse response1 = new UsersResponse(Arrays.asList(user1, user2, user3,
//                user4, user5, user6, user7, user8, user9, user10), true);
//        UsersResponse response2 = new UsersResponse(Arrays.asList(user11, user12, user13,
...
//        UsersResponse response3 = new UsersResponse(Collections.singletonList(user21), false);
